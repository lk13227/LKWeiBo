...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    ...
    static let newfeaturecell: Rswift.ReuseIdentifier<LKNewfeatureCell> = Rswift.ReuseIdentifier(identifier: "newfeaturecell")
  ...
  struct storyboard {
    /// Storyboard `Compose`.
    static let compose = _R.storyboard.compose()
    /// Storyboard `Discover`.
    ...
    /// `UIStoryboard(name: "Compose", bundle: ...)`
    static func compose(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.compose)
    }
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct compose: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      typealias InitialController = ComposeViewController
      
      let bundle = R.hostingBundle
      let name = "Compose"
      
      static func validate() throws {
        if UIKit.UIImage(named: "compose_addbutton_background") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'compose_addbutton_background' is used in storyboard 'Compose', but couldn't be loaded.") }
        if UIKit.UIImage(named: "compose_toolbar_picture") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'compose_toolbar_picture' is used in storyboard 'Compose', but couldn't be loaded.") }
        if UIKit.UIImage(named: "compose_emoticonbutton_background") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'compose_emoticonbutton_background' is used in storyboard 'Compose', but couldn't be loaded.") }
        if UIKit.UIImage(named: "compose_trendbutton_background") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'compose_trendbutton_background' is used in storyboard 'Compose', but couldn't be loaded.") }
        if UIKit.UIImage(named: "compose_mentionbutton_background") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'compose_mentionbutton_background' is used in storyboard 'Compose', but couldn't be loaded.") }
      }
    ...
    struct home: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "common_icon_membership_level6") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'common_icon_membership_level6' is used in storyboard 'Home', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "gif") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'gif' is used in storyboard 'Home', but couldn't be loaded.") }
